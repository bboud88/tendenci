...
class ProfileForm(TendenciBaseForm):
    ...
    url = forms.ChoiceField(
        choices=(('Email',_('Email')),('Phone',_('Phone')), ('SnailMail',_('SnailMail')), ('No Contact',_('No Contact')),))
    url2 = forms.ChoiceField(
        choices=(('N/A',_('N/A')),('Time commitment',_('Time commitment')), ('Work Issues',_('Work Issues')), ('Money issues',_('Money issues')), ('Moving to another team',_('Moving to another team')), ('Moving',_('Moving')), ('Retiring',_('Retiring')), ('Took up other hobby',_('Took up other hobby')), ('Other',_('Other')),))
    referral_source = forms.ChoiceField(
        choices=(('Unknown',_('Unknown')),('Facebook',_('Facebook')), ('Meetup Group',_('Meetup Group')), ('Friend',_('Friend')), ('Family Member',_('Family Member')), ('Website',_('Website')), ('Search Engine',_('Search Engine')),('Other',_('Other')),))
